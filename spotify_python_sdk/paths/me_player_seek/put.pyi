...
# Query params
PositionMsSchema = schemas.IntSchema
DeviceIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'position_ms': typing.Union[PositionMsSchema, decimal.Decimal, int, ],
    }
)
...
request_query_position_ms = api_client.QueryParameter(
    name="position_ms",
    style=api_client.ParameterStyle.FORM,
    schema=PositionMsSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _seek_to_position_mapped_args(
        self,
        position_ms: int,
        ...
        if position_ms is not None:
            _query_params["position_ms"] = position_ms
        if device_id is not None:
            _query_params["device_id"] = device_id
        args.query = _query_params
        return args

    async def _aseek_to_position_oapg(
        self,
...
class SeekToPositionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aseek_to_position(
        self,
        position_ms: int,
        device_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._seek_to_position_mapped_args(
            position_ms=position_ms,
            device_id=device_id,
        )
        return await self._aseek_to_position_oapg(
    ...
    def seek_to_position(
        ...
        return self._seek_to_position_oapg(
            query_params=args.query,
        )

class SeekToPosition(BaseApi):
    ...
    async def aseek_to_position(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aseek_to_position(
            position_ms=position_ms,
            device_id=device_id,
            **kwargs,
        )
    ...
    def seek_to_position(
        ...
        raw_response = self.raw.seek_to_position(
            position_ms=position_ms,
            device_id=device_id,
        )
