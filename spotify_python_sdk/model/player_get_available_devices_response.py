...
class PlayerGetAvailableDevicesResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class devices(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DeviceObject']:
                        return DeviceObject
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DeviceObject'], typing.List['DeviceObject']],
                ...
                def __getitem__(self, i: int) -> 'DeviceObject':
