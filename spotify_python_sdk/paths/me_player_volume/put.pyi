...
# Query params
VolumePercentSchema = schemas.IntSchema
DeviceIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'volume_percent': typing.Union[VolumePercentSchema, decimal.Decimal, int, ],
    }
)
...
request_query_volume_percent = api_client.QueryParameter(
    name="volume_percent",
    style=api_client.ParameterStyle.FORM,
    schema=VolumePercentSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _set_playback_volume_mapped_args(
        self,
        volume_percent: int,
        ...
        if volume_percent is not None:
            _query_params["volume_percent"] = volume_percent
        if device_id is not None:
            _query_params["device_id"] = device_id
        args.query = _query_params
        return args

    async def _aset_playback_volume_oapg(
        self,
...
class SetPlaybackVolumeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_playback_volume(
        self,
        volume_percent: int,
        device_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._set_playback_volume_mapped_args(
            volume_percent=volume_percent,
            device_id=device_id,
        )
        return await self._aset_playback_volume_oapg(
    ...
    def set_playback_volume(
        ...
        return self._set_playback_volume_oapg(
            query_params=args.query,
        )

class SetPlaybackVolume(BaseApi):
    ...
    async def aset_playback_volume(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_playback_volume(
            volume_percent=volume_percent,
            device_id=device_id,
            **kwargs,
        )
    ...
    def set_playback_volume(
        ...
        raw_response = self.raw.set_playback_volume(
            volume_percent=volume_percent,
            device_id=device_id,
        )
