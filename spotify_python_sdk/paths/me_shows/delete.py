...
class BaseApi(api_client.Api):
    ...
    def _remove_user_library_mapped_args(
        self,
        ids: str,
    ...
    async def _aremove_user_library_oapg(
        self,
...
class RemoveUserLibraryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_user_library(
        self,
        ids: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._remove_user_library_mapped_args(
            ids=ids,
            market=market,
        )
        return await self._aremove_user_library_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def remove_user_library(
        self,
        ids: str,
        market: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._remove_user_library_oapg(
            query_params=args.query,
        )

class RemoveUserLibrary(BaseApi):
    ...
    async def aremove_user_library(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_user_library(
            ids=ids,
            market=market,
            **kwargs,
        )
    ...
    def remove_user_library(
        ...
        raw_response = self.raw.remove_user_library(
            ids=ids,
            market=market,
        )
