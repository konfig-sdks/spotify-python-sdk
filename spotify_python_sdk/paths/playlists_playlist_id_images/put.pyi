...
# body param
SchemaForRequestBodyImageJpeg = schemas.StrSchema
...
class BaseApi(api_client.Api):
    ...
    def _replace_cover_image_mapped_args(
        self,
        playlist_id: str,
    ...
    async def _areplace_cover_image_oapg(
        self,
...
class ReplaceCoverImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_cover_image(
        self,
        playlist_id: str,
        body: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._replace_cover_image_mapped_args(
            body=body,
            playlist_id=playlist_id,
        )
        return await self._areplace_cover_image_oapg(
            body=args.body,
    ...
    def replace_cover_image(
        ...
        return self._replace_cover_image_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReplaceCoverImage(BaseApi):
    ...
    async def areplace_cover_image(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areplace_cover_image(
            body=body,
            playlist_id=playlist_id,
            **kwargs,
        )
    ...
    def replace_cover_image(
        ...
        raw_response = self.raw.replace_cover_image(
            body=body,
            playlist_id=playlist_id,
        )
