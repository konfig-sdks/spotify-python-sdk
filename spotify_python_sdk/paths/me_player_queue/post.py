...
# Query params
UriSchema = schemas.StrSchema
DeviceIdSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'uri': typing.Union[UriSchema, str, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _add_item_to_queue_mapped_args(
        self,
        uri: str,
    ...
    async def _aadd_item_to_queue_oapg(
        self,
...
class AddItemToQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_item_to_queue(
        self,
        uri: str,
        device_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._add_item_to_queue_mapped_args(
            uri=uri,
            device_id=device_id,
        )
        return await self._aadd_item_to_queue_oapg(
    ...
    def add_item_to_queue(
        ...
        return self._add_item_to_queue_oapg(
            query_params=args.query,
        )

class AddItemToQueue(BaseApi):
    ...
    async def aadd_item_to_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_item_to_queue(
            uri=uri,
            device_id=device_id,
            **kwargs,
        )
    ...
    def add_item_to_queue(
        ...
        raw_response = self.raw.add_item_to_queue(
            uri=uri,
            device_id=device_id,
        )
