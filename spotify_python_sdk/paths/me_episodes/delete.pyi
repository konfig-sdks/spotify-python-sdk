...
from spotify_python_sdk.model.episodes_remove_from_library_request_ids import EpisodesRemoveFromLibraryRequestIds as EpisodesRemoveFromLibraryRequestIdsSchema
from spotify_python_sdk.model.episodes_remove_from_library_request import EpisodesRemoveFromLibraryRequest as EpisodesRemoveFromLibraryRequestSchema
...
from spotify_python_sdk.type.episodes_remove_from_library_request_ids import EpisodesRemoveFromLibraryRequestIds
from spotify_python_sdk.type.episodes_remove_from_library_request import EpisodesRemoveFromLibraryRequest
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.episodes_remove_from_library_request_ids import EpisodesRemoveFromLibraryRequestIds as EpisodesRemoveFromLibraryRequestIdsPydantic
from spotify_python_sdk.pydantic.episodes_remove_from_library_request import EpisodesRemoveFromLibraryRequest as EpisodesRemoveFromLibraryRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EpisodesRemoveFromLibraryRequestSchema


request_body_episodes_remove_from_library_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_from_library_1_mapped_args(
        self,
        ids: str,
        ids: typing.Optional[EpisodesRemoveFromLibraryRequestIds] = None,
    ...
    async def _aremove_from_library_1_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_episodes_remove_from_library_request.serialize(body, content_type)
    ...
    def _remove_from_library_1_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RemoveFromLibrary1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_library_1(
        self,
        ids: str,
        ids: typing.Optional[EpisodesRemoveFromLibraryRequestIds] = None,
        **kwargs,
        ...
        args = self._remove_from_library_1_mapped_args(
            ids=ids,
            ids=ids,
        )
        return await self._aremove_from_library_1_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def remove_from_library_1(
        self,
        ids: str,
        ids: typing.Optional[EpisodesRemoveFromLibraryRequestIds] = None,
    ) -> typing.Union[
        ...
        return self._remove_from_library_1_oapg(
            body=args.body,
            query_params=args.query,
        )

class RemoveFromLibrary1(BaseApi):
    ...
    async def aremove_from_library_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_library_1(
            ids=ids,
            ids=ids,
            **kwargs,
        )
    ...
    def remove_from_library_1(
        ...
        raw_response = self.raw.remove_from_library_1(
            ids=ids,
            ids=ids,
        )
