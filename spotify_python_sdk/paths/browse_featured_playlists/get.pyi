...
class GetFeaturedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_featured(
        self,
        locale: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_featured_mapped_args(
            locale=locale,
            limit=limit,
            offset=offset,
        )
        return await self._aget_featured_oapg(
    ...
    def get_featured(
        ...
        return self._get_featured_oapg(
            query_params=args.query,
        )

class GetFeatured(BaseApi):
    ...
    async def aget_featured(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_featured(
            locale=locale,
            limit=limit,
            offset=offset,
            **kwargs,
    ...
    def get_featured(
        ...
        raw_response = self.raw.get_featured(
            locale=locale,
            limit=limit,
            offset=offset,
        )
