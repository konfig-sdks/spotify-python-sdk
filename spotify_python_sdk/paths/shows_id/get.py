...
from spotify_python_sdk.model.show_object import ShowObject as ShowObjectSchema
...
from spotify_python_sdk.type.show_object import ShowObject

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.show_object import ShowObject as ShowObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = ShowObjectSchema
...
class GetInformation(BaseApi):
    ...
    async def aget_information(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[ShowObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(ShowObjectPydantic, raw_response.body)
