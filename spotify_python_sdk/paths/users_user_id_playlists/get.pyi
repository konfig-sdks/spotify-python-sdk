...
from spotify_python_sdk.model.paging_playlist_object import PagingPlaylistObject as PagingPlaylistObjectSchema
...
from spotify_python_sdk.pydantic.paging_playlist_object import PagingPlaylistObject as PagingPlaylistObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingPlaylistObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingPlaylistObject
...
class GetUserPlaylists(BaseApi):
    ...
    async def aget_user_playlists(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[PagingPlaylistObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingPlaylistObjectPydantic, raw_response.body)
