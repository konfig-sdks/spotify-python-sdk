...
from spotify_python_sdk.model.track_object import TrackObject as TrackObjectSchema
...
from spotify_python_sdk.pydantic.track_object import TrackObject as TrackObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = TrackObjectSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_spotify_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_by_spotify_id_oapg(
        self,
...
class GetBySpotifyIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_spotify_id(
        self,
        id: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_by_spotify_id_mapped_args(
            id=id,
            market=market,
        )
        return await self._aget_by_spotify_id_oapg(
    ...
    def get_by_spotify_id(
        ...
        return self._get_by_spotify_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetBySpotifyId(BaseApi):
    ...
    async def aget_by_spotify_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_spotify_id(
            id=id,
            market=market,
            **kwargs,
        )
        if validate:
            return TrackObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(TrackObjectPydantic, raw_response.body)
    ...
    def get_by_spotify_id(
        ...
        raw_response = self.raw.get_by_spotify_id(
            id=id,
            market=market,
        )
        if validate:
