...
from spotify_python_sdk.model.audio_features_object import AudioFeaturesObject as AudioFeaturesObjectSchema
...
from spotify_python_sdk.type.audio_features_object import AudioFeaturesObject
...
from spotify_python_sdk.pydantic.audio_features_object import AudioFeaturesObject as AudioFeaturesObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = AudioFeaturesObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AudioFeaturesObject
...
class BaseApi(api_client.Api):
    ...
    def _get_audio_features_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_audio_features_by_id_oapg(
        self,
    ...
    def _get_audio_features_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAudioFeaturesByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_audio_features_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_audio_features_by_id_mapped_args(
            id=id,
        )
        return await self._aget_audio_features_by_id_oapg(
    ...
    def get_audio_features_by_id(
        ...
        return self._get_audio_features_by_id_oapg(
            path_params=args.path,
        )

class GetAudioFeaturesById(BaseApi):
    ...
    async def aget_audio_features_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AudioFeaturesObjectPydantic:
        raw_response = await self.raw.aget_audio_features_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return AudioFeaturesObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(AudioFeaturesObjectPydantic, raw_response.body)
    ...
    def get_audio_features_by_id(
        ...
        raw_response = self.raw.get_audio_features_by_id(
            id=id,
        )
        if validate:
            return AudioFeaturesObjectPydantic(**raw_response.body)
