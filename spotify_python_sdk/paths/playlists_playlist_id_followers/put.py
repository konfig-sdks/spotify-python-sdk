...
from spotify_python_sdk.model.users_follow_playlist_request import UsersFollowPlaylistRequest as UsersFollowPlaylistRequestSchema
...
from spotify_python_sdk.type.users_follow_playlist_request import UsersFollowPlaylistRequest
...
from spotify_python_sdk.pydantic.users_follow_playlist_request import UsersFollowPlaylistRequest as UsersFollowPlaylistRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UsersFollowPlaylistRequestSchema


request_body_users_follow_playlist_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _follow_playlist_mapped_args(
        self,
        playlist_id: str,
    ...
    async def _afollow_playlist_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_users_follow_playlist_request.serialize(body, content_type)
...
class FollowPlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afollow_playlist(
        self,
        playlist_id: str,
        public: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._follow_playlist_mapped_args(
            playlist_id=playlist_id,
            public=public,
        )
        return await self._afollow_playlist_oapg(
            body=args.body,
    ...
    def follow_playlist(
        ...
        return self._follow_playlist_oapg(
            body=args.body,
            path_params=args.path,
        )

class FollowPlaylist(BaseApi):
    ...
    async def afollow_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afollow_playlist(
            playlist_id=playlist_id,
            public=public,
            **kwargs,
        )
    ...
    def follow_playlist(
        ...
        raw_response = self.raw.follow_playlist(
            playlist_id=playlist_id,
            public=public,
        )
