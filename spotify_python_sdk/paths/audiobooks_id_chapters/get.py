...
from spotify_python_sdk.model.paging_simplified_chapter_object import PagingSimplifiedChapterObject as PagingSimplifiedChapterObjectSchema
...
from spotify_python_sdk.type.paging_simplified_chapter_object import PagingSimplifiedChapterObject
...
from spotify_python_sdk.pydantic.paging_simplified_chapter_object import PagingSimplifiedChapterObject as PagingSimplifiedChapterObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSimplifiedChapterObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSimplifiedChapterObject
...
class BaseApi(api_client.Api):
    ...
    def _get_chapters_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_chapters_by_id_oapg(
        self,
...
class GetChaptersByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_chapters_by_id(
        self,
        id: str,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_chapters_by_id_mapped_args(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
        )
        return await self._aget_chapters_by_id_oapg(
    ...
    def get_chapters_by_id(
        ...
        return self._get_chapters_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetChaptersById(BaseApi):
    ...
    async def aget_chapters_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSimplifiedChapterObjectPydantic:
        raw_response = await self.raw.aget_chapters_by_id(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return RootModel[PagingSimplifiedChapterObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSimplifiedChapterObjectPydantic, raw_response.body)
    ...
    def get_chapters_by_id(
        ...
        raw_response = self.raw.get_chapters_by_id(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
