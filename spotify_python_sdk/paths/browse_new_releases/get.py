...
from spotify_python_sdk.model.albums_get_new_releases_response import AlbumsGetNewReleasesResponse as AlbumsGetNewReleasesResponseSchema
...
from spotify_python_sdk.type.albums_get_new_releases_response import AlbumsGetNewReleasesResponse
...
from spotify_python_sdk.pydantic.albums_get_new_releases_response import AlbumsGetNewReleasesResponse as AlbumsGetNewReleasesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AlbumsGetNewReleasesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AlbumsGetNewReleasesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_new_releases_mapped_args(
        self,
    ...
    async def _aget_new_releases_oapg(
        self,
...
class GetNewReleasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_new_releases(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_new_releases_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_new_releases_oapg(
    ...
    def get_new_releases(
        ...
        return self._get_new_releases_oapg(
            query_params=args.query,
        )

class GetNewReleases(BaseApi):
    ...
    async def aget_new_releases(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AlbumsGetNewReleasesResponsePydantic:
        raw_response = await self.raw.aget_new_releases(
            limit=limit,
            offset=offset,
            **kwargs,
        )
        if validate:
            return AlbumsGetNewReleasesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AlbumsGetNewReleasesResponsePydantic, raw_response.body)
    ...
    def get_new_releases(
        ...
        raw_response = self.raw.get_new_releases(
            limit=limit,
            offset=offset,
        )
        if validate:
