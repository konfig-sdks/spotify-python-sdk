...
class CategoryObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["href", "icons", "id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["href", "icons", "id", "name", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        icons: typing.Union[MetaOapg.properties.icons, list, tuple, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
