...
from spotify_python_sdk.model.private_user_object import PrivateUserObject as PrivateUserObjectSchema
...
from spotify_python_sdk.type.private_user_object import PrivateUserObject
...
from spotify_python_sdk.pydantic.private_user_object import PrivateUserObject as PrivateUserObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PrivateUserObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PrivateUserObject
...
class BaseApi(api_client.Api):
    ...
    def _get_current_user_profile_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_current_user_profile_oapg(
        self,
    ...
    def _get_current_user_profile_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetCurrentUserProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_current_user_profile(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_current_user_profile_mapped_args(
        )
        return await self._aget_current_user_profile_oapg(
            **kwargs,
        )
    ...
    def get_current_user_profile(
        ...
        return self._get_current_user_profile_oapg(
        )

class GetCurrentUserProfile(BaseApi):

    async def aget_current_user_profile(
        self,
        validate: bool = False,
        **kwargs,
    ) -> PrivateUserObjectPydantic:
        raw_response = await self.raw.aget_current_user_profile(
            **kwargs,
        )
        if validate:
            return PrivateUserObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(PrivateUserObjectPydantic, raw_response.body)
    ...
    def get_current_user_profile(
        ...
        raw_response = self.raw.get_current_user_profile(
        )
        if validate:
            return PrivateUserObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(PrivateUserObjectPydantic, raw_response.body)
