...
from spotify_python_sdk.model.playlists_update_details_request import PlaylistsUpdateDetailsRequest as PlaylistsUpdateDetailsRequestSchema
...
from spotify_python_sdk.type.playlists_update_details_request import PlaylistsUpdateDetailsRequest
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.playlists_update_details_request import PlaylistsUpdateDetailsRequest as PlaylistsUpdateDetailsRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PlaylistsUpdateDetailsRequestSchema


request_body_playlists_update_details_request = api_client.RequestBody(
    content={
    ...
    async def _aupdate_details_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_playlists_update_details_request.serialize(body, content_type)
