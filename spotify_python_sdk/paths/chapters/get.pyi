...
from spotify_python_sdk.model.chapters_get_multiple_by_ids_response import ChaptersGetMultipleByIdsResponse as ChaptersGetMultipleByIdsResponseSchema
...
from spotify_python_sdk.type.chapters_get_multiple_by_ids_response import ChaptersGetMultipleByIdsResponse
...
from spotify_python_sdk.pydantic.chapters_get_multiple_by_ids_response import ChaptersGetMultipleByIdsResponse as ChaptersGetMultipleByIdsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ChaptersGetMultipleByIdsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ChaptersGetMultipleByIdsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_multiple_by_ids_mapped_args(
        self,
        ids: str,
    ...
    async def _aget_multiple_by_ids_oapg(
        self,
...
class GetMultipleByIdsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_multiple_by_ids(
        self,
        ids: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_multiple_by_ids_mapped_args(
            ids=ids,
            market=market,
        )
        return await self._aget_multiple_by_ids_oapg(
    ...
    def get_multiple_by_ids(
        ...
        return self._get_multiple_by_ids_oapg(
            query_params=args.query,
        )

class GetMultipleByIds(BaseApi):
    ...
    async def aget_multiple_by_ids(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChaptersGetMultipleByIdsResponsePydantic:
        raw_response = await self.raw.aget_multiple_by_ids(
            ids=ids,
            market=market,
            **kwargs,
        )
        if validate:
            return ChaptersGetMultipleByIdsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ChaptersGetMultipleByIdsResponsePydantic, raw_response.body)
    ...
    def get_multiple_by_ids(
        ...
        raw_response = self.raw.get_multiple_by_ids(
            ids=ids,
            market=market,
        )
        if validate:
