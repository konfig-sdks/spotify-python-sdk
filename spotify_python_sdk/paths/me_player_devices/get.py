...
from spotify_python_sdk.model.player_get_available_devices_response import PlayerGetAvailableDevicesResponse as PlayerGetAvailableDevicesResponseSchema
...
from spotify_python_sdk.type.player_get_available_devices_response import PlayerGetAvailableDevicesResponse
...
from spotify_python_sdk.pydantic.player_get_available_devices_response import PlayerGetAvailableDevicesResponse as PlayerGetAvailableDevicesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PlayerGetAvailableDevicesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PlayerGetAvailableDevicesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_available_devices_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_available_devices_oapg(
        self,
    ...
    def _get_available_devices_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class GetAvailableDevicesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_available_devices(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_available_devices_mapped_args(
        )
        return await self._aget_available_devices_oapg(
            **kwargs,
        )
    ...
    def get_available_devices(
        ...
        return self._get_available_devices_oapg(
        )

class GetAvailableDevices(BaseApi):

    async def aget_available_devices(
        self,
        validate: bool = False,
        **kwargs,
    ) -> PlayerGetAvailableDevicesResponsePydantic:
        raw_response = await self.raw.aget_available_devices(
            **kwargs,
        )
        if validate:
            return PlayerGetAvailableDevicesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlayerGetAvailableDevicesResponsePydantic, raw_response.body)
    ...
    def get_available_devices(
        ...
        raw_response = self.raw.get_available_devices(
        )
        if validate:
            return PlayerGetAvailableDevicesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PlayerGetAvailableDevicesResponsePydantic, raw_response.body)
