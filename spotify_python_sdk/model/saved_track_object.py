...
class SavedTrackObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["added_at", "track", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["added_at", "track", ], str]):
