...
class BaseApi(api_client.Api):
    ...
    def _get_current_playback_state_mapped_args(
        self,
    ...
    async def _aget_current_playback_state_oapg(
        self,
    ...
    def _get_current_playback_state_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCurrentPlaybackStateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_current_playback_state(
        self,
        market: typing.Optional[str] = None,
        additional_types: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_current_playback_state_mapped_args(
            market=market,
            additional_types=additional_types,
        )
        return await self._aget_current_playback_state_oapg(
    ...
    def get_current_playback_state(
        ...
        return self._get_current_playback_state_oapg(
            query_params=args.query,
        )

class GetCurrentPlaybackState(BaseApi):
    ...
    async def aget_current_playback_state(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_current_playback_state(
            market=market,
            additional_types=additional_types,
            **kwargs,
        )
    ...
    def get_current_playback_state(
        ...
        raw_response = self.raw.get_current_playback_state(
            market=market,
            additional_types=additional_types,
        )
        if validate:
