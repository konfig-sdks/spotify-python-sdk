...
from spotify_python_sdk.model.markets_list_available_response import MarketsListAvailableResponse as MarketsListAvailableResponseSchema
...
from spotify_python_sdk.type.markets_list_available_response import MarketsListAvailableResponse
...
from spotify_python_sdk.pydantic.markets_list_available_response import MarketsListAvailableResponse as MarketsListAvailableResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MarketsListAvailableResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MarketsListAvailableResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_available_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _alist_available_oapg(
        self,
...
class ListAvailableRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_available(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._list_available_mapped_args(
        )
        return await self._alist_available_oapg(
            **kwargs,
        )
    ...
    def list_available(
        ...
        return self._list_available_oapg(
        )

class ListAvailable(BaseApi):

    async def alist_available(
        self,
        validate: bool = False,
        **kwargs,
    ) -> MarketsListAvailableResponsePydantic:
        raw_response = await self.raw.alist_available(
            **kwargs,
        )
        if validate:
            return MarketsListAvailableResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MarketsListAvailableResponsePydantic, raw_response.body)
    ...
    def list_available(
        ...
        raw_response = self.raw.list_available(
        )
        if validate:
            return MarketsListAvailableResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MarketsListAvailableResponsePydantic, raw_response.body)
