...
from spotify_python_sdk.model.audiobooks_get_several_response import AudiobooksGetSeveralResponse as AudiobooksGetSeveralResponseSchema
...
from spotify_python_sdk.type.audiobooks_get_several_response import AudiobooksGetSeveralResponse
...
from spotify_python_sdk.pydantic.audiobooks_get_several_response import AudiobooksGetSeveralResponse as AudiobooksGetSeveralResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AudiobooksGetSeveralResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AudiobooksGetSeveralResponse
...
class GetSeveralRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_several(
        self,
        ids: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_several_mapped_args(
            ids=ids,
            market=market,
        )
        return await self._aget_several_oapg(
    ...
    def get_several(
        ...
        return self._get_several_oapg(
            query_params=args.query,
        )

class GetSeveral(BaseApi):
    ...
    async def aget_several(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AudiobooksGetSeveralResponsePydantic:
        raw_response = await self.raw.aget_several(
            ids=ids,
            market=market,
            **kwargs,
        )
        if validate:
            return AudiobooksGetSeveralResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AudiobooksGetSeveralResponsePydantic, raw_response.body)
    ...
    def get_several(
        ...
        raw_response = self.raw.get_several(
            ids=ids,
            market=market,
        )
        if validate:
