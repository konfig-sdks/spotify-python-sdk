...
from spotify_python_sdk.model.paging_simplified_track_object import PagingSimplifiedTrackObject as PagingSimplifiedTrackObjectSchema
...
from spotify_python_sdk.type.paging_simplified_track_object import PagingSimplifiedTrackObject

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.paging_simplified_track_object import PagingSimplifiedTrackObject as PagingSimplifiedTrackObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSimplifiedTrackObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSimplifiedTrackObject
...
class BaseApi(api_client.Api):
    ...
    def _get_tracks_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_tracks_by_id_oapg(
        self,
...
class GetTracksByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tracks_by_id(
        self,
        id: str,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_tracks_by_id_mapped_args(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
        )
        return await self._aget_tracks_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_tracks_by_id(
        self,
        id: str,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_tracks_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTracksById(BaseApi):
    ...
    async def aget_tracks_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSimplifiedTrackObjectPydantic:
        raw_response = await self.raw.aget_tracks_by_id(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return RootModel[PagingSimplifiedTrackObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSimplifiedTrackObjectPydantic, raw_response.body)
    ...
    def get_tracks_by_id(
        ...
        raw_response = self.raw.get_tracks_by_id(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
