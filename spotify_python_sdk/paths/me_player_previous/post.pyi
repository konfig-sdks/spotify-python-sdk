...
class BaseApi(api_client.Api):
    ...
    def _skip_to_previous_track_mapped_args(
        self,
    ...
    async def _askip_to_previous_track_oapg(
        self,
    ...
    def _skip_to_previous_track_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SkipToPreviousTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def askip_to_previous_track(
        self,
        device_id: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._skip_to_previous_track_mapped_args(
            device_id=device_id,
        )
        return await self._askip_to_previous_track_oapg(
    ...
    def skip_to_previous_track(
        ...
        return self._skip_to_previous_track_oapg(
            query_params=args.query,
        )

class SkipToPreviousTrack(BaseApi):
    ...
    async def askip_to_previous_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.askip_to_previous_track(
            device_id=device_id,
            **kwargs,
        )
    ...
    def skip_to_previous_track(
        ...
        raw_response = self.raw.skip_to_previous_track(
            device_id=device_id,
        )
