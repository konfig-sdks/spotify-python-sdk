...
class BaseApi(api_client.Api):
    ...
    def _skip_to_next_track_mapped_args(
        self,
    ...
    async def _askip_to_next_track_oapg(
        self,
...
class SkipToNextTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def askip_to_next_track(
        self,
        device_id: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._skip_to_next_track_mapped_args(
            device_id=device_id,
        )
        return await self._askip_to_next_track_oapg(
    ...
    def skip_to_next_track(
        ...
        return self._skip_to_next_track_oapg(
            query_params=args.query,
        )

class SkipToNextTrack(BaseApi):
    ...
    async def askip_to_next_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.askip_to_next_track(
            device_id=device_id,
            **kwargs,
        )
    ...
    def skip_to_next_track(
        ...
        raw_response = self.raw.skip_to_next_track(
            device_id=device_id,
        )
