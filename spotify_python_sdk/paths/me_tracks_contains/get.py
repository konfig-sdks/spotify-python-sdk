...
class CheckSavedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_saved(
        self,
        ids: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_saved_mapped_args(
            ids=ids,
        )
        return await self._acheck_saved_oapg(
    ...
    def check_saved(
        ...
        return self._check_saved_oapg(
            query_params=args.query,
        )

class CheckSaved(BaseApi):
    ...
    async def acheck_saved(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_saved(
            ids=ids,
            **kwargs,
        )
        if validate:
    ...
    def check_saved(
        ...
        raw_response = self.raw.check_saved(
            ids=ids,
        )
        if validate:
            return RootModel[AudiobooksCheckUserSavedResponsePydantic](raw_response.body).root
