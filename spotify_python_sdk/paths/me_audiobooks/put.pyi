...
class BaseApi(api_client.Api):
    ...
    def _save_current_user_library_mapped_args(
        self,
        ids: str,
    ...
    async def _asave_current_user_library_oapg(
        self,
    ...
    def _save_current_user_library_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SaveCurrentUserLibraryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asave_current_user_library(
        self,
        ids: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._save_current_user_library_mapped_args(
            ids=ids,
        )
        return await self._asave_current_user_library_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def save_current_user_library(
        self,
        ids: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._save_current_user_library_oapg(
            query_params=args.query,
        )

class SaveCurrentUserLibrary(BaseApi):
    ...
    async def asave_current_user_library(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asave_current_user_library(
            ids=ids,
            **kwargs,
        )
    ...
    def save_current_user_library(
        ...
        raw_response = self.raw.save_current_user_library(
            ids=ids,
        )
