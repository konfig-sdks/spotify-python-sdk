...
from spotify_python_sdk.model.tracks_save_for_current_user_request_ids import TracksSaveForCurrentUserRequestIds as TracksSaveForCurrentUserRequestIdsSchema
...
from spotify_python_sdk.model.tracks_save_for_current_user_request import TracksSaveForCurrentUserRequest as TracksSaveForCurrentUserRequestSchema
...
from spotify_python_sdk.type.tracks_save_for_current_user_request_ids import TracksSaveForCurrentUserRequestIds
from spotify_python_sdk.type.tracks_save_for_current_user_request import TracksSaveForCurrentUserRequest
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.tracks_save_for_current_user_request_ids import TracksSaveForCurrentUserRequestIds as TracksSaveForCurrentUserRequestIdsPydantic
...
from spotify_python_sdk.pydantic.tracks_save_for_current_user_request import TracksSaveForCurrentUserRequest as TracksSaveForCurrentUserRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TracksSaveForCurrentUserRequestSchema


request_body_tracks_save_for_current_user_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_for_current_user_mapped_args(
        self,
        ids: str,
        ids: typing.Optional[TracksSaveForCurrentUserRequestIds] = None,
    ...
    async def _asave_for_current_user_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_tracks_save_for_current_user_request.serialize(body, content_type)
    ...
    def _save_for_current_user_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SaveForCurrentUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asave_for_current_user(
        self,
        ids: str,
        ids: typing.Optional[TracksSaveForCurrentUserRequestIds] = None,
        **kwargs,
        ...
        args = self._save_for_current_user_mapped_args(
            ids=ids,
            ids=ids,
        )
        return await self._asave_for_current_user_oapg(
            body=args.body,
    ...
    def save_for_current_user(
        ...
        return self._save_for_current_user_oapg(
            body=args.body,
            query_params=args.query,
        )

class SaveForCurrentUser(BaseApi):
    ...
    async def asave_for_current_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asave_for_current_user(
            ids=ids,
            ids=ids,
            **kwargs,
        )
    ...
    def save_for_current_user(
        ...
        raw_response = self.raw.save_for_current_user(
            ids=ids,
            ids=ids,
        )
