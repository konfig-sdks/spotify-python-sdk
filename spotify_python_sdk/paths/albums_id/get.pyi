...
from spotify_python_sdk.model.album_object import AlbumObject as AlbumObjectSchema
...
from spotify_python_sdk.type.album_object import AlbumObject
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.album_object import AlbumObject as AlbumObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = AlbumObjectSchema
...
class GetInformation(BaseApi):
    ...
    async def aget_information(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[AlbumObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(AlbumObjectPydantic, raw_response.body)
