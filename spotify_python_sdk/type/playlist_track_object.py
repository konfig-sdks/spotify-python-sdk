...
from spotify_python_sdk.type.playlist_user_object import PlaylistUserObject
from spotify_python_sdk.type.track_object import TrackObject

class RequiredPlaylistTrackObject(TypedDict):
    pass

class OptionalPlaylistTrackObject(TypedDict, total=False):
    ...
    track: typing.Union[TrackObject, EpisodeObject]

class PlaylistTrackObject(RequiredPlaylistTrackObject, OptionalPlaylistTrackObject):
    pass
