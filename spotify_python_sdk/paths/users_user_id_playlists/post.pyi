...
from spotify_python_sdk.model.playlists_create_playlist_request import PlaylistsCreatePlaylistRequest as PlaylistsCreatePlaylistRequestSchema
...
from spotify_python_sdk.type.playlists_create_playlist_request import PlaylistsCreatePlaylistRequest
...
from spotify_python_sdk.pydantic.playlists_create_playlist_request import PlaylistsCreatePlaylistRequest as PlaylistsCreatePlaylistRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PlaylistsCreatePlaylistRequestSchema


request_body_playlists_create_playlist_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PlaylistObjectSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_playlist_mapped_args(
        self,
        name: str,
        user_id: str,
        description: typing.Optional[str] = None,
        public: typing.Optional[bool] = None,
        collaborative: typing.Optional[bool] = None,
        ...
        if collaborative is not None:
            _body["collaborative"] = collaborative
        args.body = _body
    ...
    async def _acreate_playlist_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_playlists_create_playlist_request.serialize(body, content_type)
...
class CreatePlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_playlist(
        self,
        name: str,
        user_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_playlist_mapped_args(
            name=name,
            user_id=user_id,
        ...
        return await self._acreate_playlist_oapg(
            body=args.body,
    ...
    def create_playlist(
        ...
        return self._create_playlist_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreatePlaylist(BaseApi):
    ...
    async def acreate_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_playlist(
            name=name,
            user_id=user_id,
            description=description,
            public=public,
    ...
    def create_playlist(
        ...
        raw_response = self.raw.create_playlist(
            name=name,
            user_id=user_id,
            description=description,
            public=public,
