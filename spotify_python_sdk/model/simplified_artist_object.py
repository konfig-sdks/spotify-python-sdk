...
class SimplifiedArtistObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["external_urls", "href", "id", "name", "type", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["external_urls", "href", "id", "name", "type", "uri", ], str]):
