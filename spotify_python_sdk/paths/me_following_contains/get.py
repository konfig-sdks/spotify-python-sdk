...
from spotify_python_sdk.model.audiobooks_check_user_saved_response import AudiobooksCheckUserSavedResponse as AudiobooksCheckUserSavedResponseSchema
...
from spotify_python_sdk.type.audiobooks_check_user_saved_response import AudiobooksCheckUserSavedResponse
...
from spotify_python_sdk.pydantic.audiobooks_check_user_saved_response import AudiobooksCheckUserSavedResponse as AudiobooksCheckUserSavedResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AudiobooksCheckUserSavedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AudiobooksCheckUserSavedResponse
...
class BaseApi(api_client.Api):
    ...
    def _check_following_artists_users_mapped_args(
        self,
        type: str,
        ids: str,
    ...
    async def _acheck_following_artists_users_oapg(
        self,
    ...
    def _check_following_artists_users_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckFollowingArtistsUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_following_artists_users(
        self,
        type: str,
        ids: str,
        **kwargs,
        ...
        args = self._check_following_artists_users_mapped_args(
            type=type,
            ids=ids,
        )
        return await self._acheck_following_artists_users_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def check_following_artists_users(
        self,
        type: str,
        ids: str,
    ) -> typing.Union[
        ...
        return self._check_following_artists_users_oapg(
            query_params=args.query,
        )

class CheckFollowingArtistsUsers(BaseApi):
    ...
    async def acheck_following_artists_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AudiobooksCheckUserSavedResponsePydantic:
        raw_response = await self.raw.acheck_following_artists_users(
            type=type,
            ids=ids,
            **kwargs,
        )
        if validate:
            return RootModel[AudiobooksCheckUserSavedResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AudiobooksCheckUserSavedResponsePydantic, raw_response.body)
    ...
    def check_following_artists_users(
        ...
        raw_response = self.raw.check_following_artists_users(
            type=type,
            ids=ids,
        )
        if validate:
