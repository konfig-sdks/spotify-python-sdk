...
from spotify_python_sdk.model.users_get_top_items_response import UsersGetTopItemsResponse as UsersGetTopItemsResponseSchema
...
from spotify_python_sdk.type.users_get_top_items_response import UsersGetTopItemsResponse
...
from spotify_python_sdk.pydantic.users_get_top_items_response import UsersGetTopItemsResponse as UsersGetTopItemsResponsePydantic
...
# Query params
TimeRangeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'time_range': typing.Union[TimeRangeSchema, str, ],
...
request_query_time_range = api_client.QueryParameter(
    name="time_range",
...
SchemaFor200ResponseBodyApplicationJson = UsersGetTopItemsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersGetTopItemsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_top_items_mapped_args(
        self,
        type: str,
        ...
        if time_range is not None:
            _query_params["time_range"] = time_range
    ...
    async def _aget_top_items_oapg(
        self,
...
class GetTopItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_top_items(
        self,
        type: str,
        time_range: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_top_items_mapped_args(
            type=type,
            time_range=time_range,
            limit=limit,
            offset=offset,
        )
        return await self._aget_top_items_oapg(
    ...
    def get_top_items(
        ...
        return self._get_top_items_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTopItems(BaseApi):
    ...
    async def aget_top_items(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersGetTopItemsResponsePydantic:
        raw_response = await self.raw.aget_top_items(
            type=type,
            time_range=time_range,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return RootModel[UsersGetTopItemsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UsersGetTopItemsResponsePydantic, raw_response.body)
    ...
    def get_top_items(
        ...
        raw_response = self.raw.get_top_items(
            type=type,
            time_range=time_range,
            limit=limit,
            offset=offset,
