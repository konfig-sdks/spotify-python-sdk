...
class ExternalIdObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isrc", "ean", "upc", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isrc", "ean", "upc", ], str]):
