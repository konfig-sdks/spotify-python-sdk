...
from spotify_python_sdk.model.paging_simplified_episode_object import PagingSimplifiedEpisodeObject as PagingSimplifiedEpisodeObjectSchema
...
from spotify_python_sdk.type.paging_simplified_episode_object import PagingSimplifiedEpisodeObject
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.paging_simplified_episode_object import PagingSimplifiedEpisodeObject as PagingSimplifiedEpisodeObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSimplifiedEpisodeObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSimplifiedEpisodeObject
...
class BaseApi(api_client.Api):
    ...
    def _get_episodes_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_episodes_by_id_oapg(
        self,
...
class GetEpisodesByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_episodes_by_id(
        self,
        id: str,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_episodes_by_id_mapped_args(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
        )
        return await self._aget_episodes_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_episodes_by_id(
        self,
        id: str,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        return self._get_episodes_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetEpisodesById(BaseApi):
    ...
    async def aget_episodes_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSimplifiedEpisodeObjectPydantic:
        raw_response = await self.raw.aget_episodes_by_id(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return RootModel[PagingSimplifiedEpisodeObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSimplifiedEpisodeObjectPydantic, raw_response.body)
    ...
    def get_episodes_by_id(
        ...
        raw_response = self.raw.get_episodes_by_id(
            id=id,
            market=market,
            limit=limit,
            offset=offset,
