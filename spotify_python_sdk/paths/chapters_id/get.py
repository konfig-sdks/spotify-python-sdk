...
from spotify_python_sdk.model.chapter_object import ChapterObject as ChapterObjectSchema
...
from spotify_python_sdk.type.chapter_object import ChapterObject
...
from spotify_python_sdk.pydantic.chapter_object import ChapterObject as ChapterObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = ChapterObjectSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_chapter_info_mapped_args(
        self,
        id: str,
    ...
    async def _aget_chapter_info_oapg(
        self,
...
class GetChapterInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_chapter_info(
        self,
        id: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_chapter_info_mapped_args(
            id=id,
            market=market,
        )
        return await self._aget_chapter_info_oapg(
    ...
    def get_chapter_info(
        ...
        return self._get_chapter_info_oapg(
            query_params=args.query,
            path_params=args.path,
        )
...
class GetChapterInfo(BaseApi):
    ...
    async def aget_chapter_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ChapterObjectPydantic:
        raw_response = await self.raw.aget_chapter_info(
            id=id,
            market=market,
            **kwargs,
        )
        if validate:
            return RootModel[ChapterObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(ChapterObjectPydantic, raw_response.body)
    ...
    def get_chapter_info(
        ...
        raw_response = self.raw.get_chapter_info(
            id=id,
            market=market,
        )
        if validate:
