...
from spotify_python_sdk.model.users_get_followed_artists_response import UsersGetFollowedArtistsResponse as UsersGetFollowedArtistsResponseSchema
...
from spotify_python_sdk.type.users_get_followed_artists_response import UsersGetFollowedArtistsResponse
...
from spotify_python_sdk.pydantic.users_get_followed_artists_response import UsersGetFollowedArtistsResponse as UsersGetFollowedArtistsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsersGetFollowedArtistsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsersGetFollowedArtistsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_followed_artists_mapped_args(
        self,
        type: str,
    ...
    async def _aget_followed_artists_oapg(
        self,
    ...
    def _get_followed_artists_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFollowedArtistsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_followed_artists(
        self,
        type: str,
        after: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_followed_artists_mapped_args(
            type=type,
            after=after,
            limit=limit,
        )
        return await self._aget_followed_artists_oapg(
    ...
    def get_followed_artists(
        ...
        return self._get_followed_artists_oapg(
            query_params=args.query,
        )

class GetFollowedArtists(BaseApi):
    ...
    async def aget_followed_artists(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsersGetFollowedArtistsResponsePydantic:
        raw_response = await self.raw.aget_followed_artists(
            type=type,
            after=after,
            limit=limit,
            **kwargs,
        ...
        if validate:
            return UsersGetFollowedArtistsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsersGetFollowedArtistsResponsePydantic, raw_response.body)
    ...
    def get_followed_artists(
        ...
        raw_response = self.raw.get_followed_artists(
            type=type,
            after=after,
            limit=limit,
        )
