...
from spotify_python_sdk.model.playlists_get_cover_image_response import PlaylistsGetCoverImageResponse as PlaylistsGetCoverImageResponseSchema
...
from spotify_python_sdk.type.playlists_get_cover_image_response import PlaylistsGetCoverImageResponse
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.playlists_get_cover_image_response import PlaylistsGetCoverImageResponse as PlaylistsGetCoverImageResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PlaylistsGetCoverImageResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PlaylistsGetCoverImageResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_cover_image_mapped_args(
        self,
        playlist_id: str,
    ...
    async def _aget_cover_image_oapg(
        self,
...
class GetCoverImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cover_image(
        self,
        playlist_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_cover_image_mapped_args(
            playlist_id=playlist_id,
        )
        return await self._aget_cover_image_oapg(
    ...
    def get_cover_image(
        ...
        return self._get_cover_image_oapg(
            path_params=args.path,
        )

class GetCoverImage(BaseApi):
    ...
    async def aget_cover_image(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PlaylistsGetCoverImageResponsePydantic:
        raw_response = await self.raw.aget_cover_image(
            playlist_id=playlist_id,
            **kwargs,
        )
        if validate:
            return RootModel[PlaylistsGetCoverImageResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PlaylistsGetCoverImageResponsePydantic, raw_response.body)
    ...
    def get_cover_image(
        ...
        raw_response = self.raw.get_cover_image(
            playlist_id=playlist_id,
        )
        if validate:
            return RootModel[PlaylistsGetCoverImageResponsePydantic](raw_response.body).root
