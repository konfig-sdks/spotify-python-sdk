...
class BaseApi(api_client.Api):
    ...
    def _get_top_tracks_mapped_args(
        self,
        id: str,
    ...
    async def _aget_top_tracks_oapg(
        self,
...
class GetTopTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_top_tracks(
        self,
        id: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_top_tracks_mapped_args(
            id=id,
            market=market,
        )
        return await self._aget_top_tracks_oapg(
    ...
    def get_top_tracks(
        ...
        return self._get_top_tracks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetTopTracks(BaseApi):
    ...
    async def aget_top_tracks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_top_tracks(
            id=id,
            market=market,
            **kwargs,
        )
    ...
    def get_top_tracks(
        ...
        raw_response = self.raw.get_top_tracks(
            id=id,
            market=market,
        )
        if validate:
