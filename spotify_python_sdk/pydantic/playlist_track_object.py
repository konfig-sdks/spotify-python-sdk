...
from spotify_python_sdk.pydantic.playlist_user_object import PlaylistUserObject
...
class PlaylistTrackObject(BaseModel):
    ...
    added_at: typing.Optional[datetime] = Field(None, alias='added_at')

    # The Spotify user who added the track or episode. _**Note**: some very old playlists may return `null` in this field._ 
    added_by: typing.Optional[PlaylistUserObject] = Field(None, alias='added_by')
    ...
    track: typing.Optional[typing.Union[TrackObject, EpisodeObject]] = Field(None, alias='track')
    class Config:
