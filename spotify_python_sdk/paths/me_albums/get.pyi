...
from spotify_python_sdk.model.paging_saved_album_object import PagingSavedAlbumObject as PagingSavedAlbumObjectSchema
...
from spotify_python_sdk.type.paging_saved_album_object import PagingSavedAlbumObject
...
from spotify_python_sdk.pydantic.paging_saved_album_object import PagingSavedAlbumObject as PagingSavedAlbumObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSavedAlbumObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSavedAlbumObject
...
class GetSavedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_saved(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_saved_mapped_args(
            limit=limit,
            offset=offset,
            market=market,
        )
        return await self._aget_saved_oapg(
    ...
    def get_saved(
        ...
        return self._get_saved_oapg(
            query_params=args.query,
        )

class GetSaved(BaseApi):
    ...
    async def aget_saved(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSavedAlbumObjectPydantic:
        raw_response = await self.raw.aget_saved(
            limit=limit,
            offset=offset,
            market=market,
            **kwargs,
        ...
        if validate:
            return RootModel[PagingSavedAlbumObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSavedAlbumObjectPydantic, raw_response.body)
    ...
    def get_saved(
        ...
        raw_response = self.raw.get_saved(
            limit=limit,
            offset=offset,
            market=market,
        )
