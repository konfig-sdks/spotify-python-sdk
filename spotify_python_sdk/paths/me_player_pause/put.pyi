...
class BaseApi(api_client.Api):
    ...
    def _pause_playback_mapped_args(
        self,
    ...
    async def _apause_playback_oapg(
        self,
...
class PausePlaybackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apause_playback(
        self,
        device_id: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._pause_playback_mapped_args(
            device_id=device_id,
        )
        return await self._apause_playback_oapg(
    ...
    def pause_playback(
        ...
        return self._pause_playback_oapg(
            query_params=args.query,
        )

class PausePlayback(BaseApi):
    ...
    async def apause_playback(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apause_playback(
            device_id=device_id,
            **kwargs,
        )
    ...
    def pause_playback(
        ...
        raw_response = self.raw.pause_playback(
            device_id=device_id,
        )
