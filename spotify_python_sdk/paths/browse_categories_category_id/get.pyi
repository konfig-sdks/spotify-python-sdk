...
from spotify_python_sdk.model.category_object import CategoryObject as CategoryObjectSchema
...
from spotify_python_sdk.type.category_object import CategoryObject
...
from spotify_python_sdk.pydantic.category_object import CategoryObject as CategoryObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = CategoryObjectSchema
...
class GetSingleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single(
        self,
        category_id: str,
        locale: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_single_mapped_args(
            category_id=category_id,
            locale=locale,
        )
        return await self._aget_single_oapg(
    ...
    def get_single(
        ...
        return self._get_single_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetSingle(BaseApi):
    ...
    async def aget_single(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CategoryObjectPydantic:
        raw_response = await self.raw.aget_single(
            category_id=category_id,
            locale=locale,
            **kwargs,
        )
        if validate:
            return CategoryObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(CategoryObjectPydantic, raw_response.body)
    ...
    def get_single(
        ...
        raw_response = self.raw.get_single(
            category_id=category_id,
            locale=locale,
        )
        if validate:
