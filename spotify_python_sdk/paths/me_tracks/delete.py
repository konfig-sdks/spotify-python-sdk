...
from spotify_python_sdk.model.tracks_remove_from_library_request_ids import TracksRemoveFromLibraryRequestIds as TracksRemoveFromLibraryRequestIdsSchema
from spotify_python_sdk.model.tracks_remove_from_library_request import TracksRemoveFromLibraryRequest as TracksRemoveFromLibraryRequestSchema
...
from spotify_python_sdk.type.tracks_remove_from_library_request import TracksRemoveFromLibraryRequest
...
from spotify_python_sdk.type.tracks_remove_from_library_request_ids import TracksRemoveFromLibraryRequestIds
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.tracks_remove_from_library_request import TracksRemoveFromLibraryRequest as TracksRemoveFromLibraryRequestPydantic
from spotify_python_sdk.pydantic.tracks_remove_from_library_request_ids import TracksRemoveFromLibraryRequestIds as TracksRemoveFromLibraryRequestIdsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = TracksRemoveFromLibraryRequestSchema


request_body_tracks_remove_from_library_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_from_library_mapped_args(
        self,
        ids: str,
        ids: typing.Optional[TracksRemoveFromLibraryRequestIds] = None,
    ...
    async def _aremove_from_library_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_tracks_remove_from_library_request.serialize(body, content_type)
...
class RemoveFromLibraryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_from_library(
        self,
        ids: str,
        ids: typing.Optional[TracksRemoveFromLibraryRequestIds] = None,
        **kwargs,
        ...
        args = self._remove_from_library_mapped_args(
            ids=ids,
            ids=ids,
        )
        return await self._aremove_from_library_oapg(
            body=args.body,
    ...
    def remove_from_library(
        ...
        return self._remove_from_library_oapg(
            body=args.body,
            query_params=args.query,
        )

class RemoveFromLibrary(BaseApi):
    ...
    async def aremove_from_library(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_from_library(
            ids=ids,
            ids=ids,
            **kwargs,
        )
    ...
    def remove_from_library(
        ...
        raw_response = self.raw.remove_from_library(
            ids=ids,
            ids=ids,
        )
