...
from spotify_python_sdk.model.currently_playing_context_object import CurrentlyPlayingContextObject as CurrentlyPlayingContextObjectSchema
...
from spotify_python_sdk.type.currently_playing_context_object import CurrentlyPlayingContextObject

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.currently_playing_context_object import CurrentlyPlayingContextObject as CurrentlyPlayingContextObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = CurrentlyPlayingContextObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CurrentlyPlayingContextObject
...
class BaseApi(api_client.Api):
    ...
    def _get_currently_playing_track_mapped_args(
        self,
    ...
    async def _aget_currently_playing_track_oapg(
        self,
    ...
    def _get_currently_playing_track_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCurrentlyPlayingTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_currently_playing_track(
        self,
        market: typing.Optional[str] = None,
        additional_types: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_currently_playing_track_mapped_args(
            market=market,
            additional_types=additional_types,
        )
        return await self._aget_currently_playing_track_oapg(
    ...
    def get_currently_playing_track(
        ...
        return self._get_currently_playing_track_oapg(
            query_params=args.query,
        )

class GetCurrentlyPlayingTrack(BaseApi):
    ...
    async def aget_currently_playing_track(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CurrentlyPlayingContextObjectPydantic:
        raw_response = await self.raw.aget_currently_playing_track(
            market=market,
            additional_types=additional_types,
            **kwargs,
        )
        if validate:
            return CurrentlyPlayingContextObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(CurrentlyPlayingContextObjectPydantic, raw_response.body)
    ...
    def get_currently_playing_track(
        ...
        raw_response = self.raw.get_currently_playing_track(
            market=market,
            additional_types=additional_types,
        )
        if validate:
