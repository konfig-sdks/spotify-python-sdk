...
class BaseApi(api_client.Api):
    ...
    def _check_saved_episodes_mapped_args(
        self,
        ids: str,
    ...
    async def _acheck_saved_episodes_oapg(
        self,
    ...
    def _check_saved_episodes_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckSavedEpisodesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_saved_episodes(
        self,
        ids: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_saved_episodes_mapped_args(
            ids=ids,
        )
        return await self._acheck_saved_episodes_oapg(
    ...
    def check_saved_episodes(
        ...
        return self._check_saved_episodes_oapg(
            query_params=args.query,
        )

class CheckSavedEpisodes(BaseApi):
    ...
    async def acheck_saved_episodes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_saved_episodes(
            ids=ids,
            **kwargs,
        )
        if validate:
    ...
    def check_saved_episodes(
        ...
        raw_response = self.raw.check_saved_episodes(
            ids=ids,
        )
        if validate:
            return RootModel[AudiobooksCheckUserSavedResponsePydantic](raw_response.body).root
