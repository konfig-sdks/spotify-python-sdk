...
from spotify_python_sdk.model.albums_remove_saved_request import AlbumsRemoveSavedRequest as AlbumsRemoveSavedRequestSchema
from spotify_python_sdk.model.albums_remove_saved_request_ids import AlbumsRemoveSavedRequestIds as AlbumsRemoveSavedRequestIdsSchema
...
from spotify_python_sdk.type.albums_remove_saved_request import AlbumsRemoveSavedRequest
...
from spotify_python_sdk.type.albums_remove_saved_request_ids import AlbumsRemoveSavedRequestIds
...
from spotify_python_sdk.pydantic.albums_remove_saved_request_ids import AlbumsRemoveSavedRequestIds as AlbumsRemoveSavedRequestIdsPydantic
...
from spotify_python_sdk.pydantic.albums_remove_saved_request import AlbumsRemoveSavedRequest as AlbumsRemoveSavedRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AlbumsRemoveSavedRequestSchema


request_body_albums_remove_saved_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_saved_mapped_args(
        self,
        ids: str,
        ids: typing.Optional[AlbumsRemoveSavedRequestIds] = None,
    ...
    async def _aremove_saved_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_albums_remove_saved_request.serialize(body, content_type)
...
class RemoveSavedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_saved(
        self,
        ids: str,
        ids: typing.Optional[AlbumsRemoveSavedRequestIds] = None,
        **kwargs,
        ...
        args = self._remove_saved_mapped_args(
            ids=ids,
            ids=ids,
        )
        return await self._aremove_saved_oapg(
            body=args.body,
    ...
    def remove_saved(
        ...
        return self._remove_saved_oapg(
            body=args.body,
            query_params=args.query,
        )

class RemoveSaved(BaseApi):
    ...
    async def aremove_saved(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_saved(
            ids=ids,
            ids=ids,
            **kwargs,
        )
    ...
    def remove_saved(
        ...
        raw_response = self.raw.remove_saved(
            ids=ids,
            ids=ids,
        )
