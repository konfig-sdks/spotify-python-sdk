...
from spotify_python_sdk.model.episodes_get_several_response import EpisodesGetSeveralResponse as EpisodesGetSeveralResponseSchema
...
from spotify_python_sdk.type.episodes_get_several_response import EpisodesGetSeveralResponse
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.episodes_get_several_response import EpisodesGetSeveralResponse as EpisodesGetSeveralResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EpisodesGetSeveralResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EpisodesGetSeveralResponse
...
class GetSeveral(BaseApi):
    ...
    async def aget_several(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EpisodesGetSeveralResponsePydantic:
        ...
        if validate:
            return EpisodesGetSeveralResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EpisodesGetSeveralResponsePydantic, raw_response.body)
