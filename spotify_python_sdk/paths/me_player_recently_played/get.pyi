...
from spotify_python_sdk.model.cursor_paging_play_history_object import CursorPagingPlayHistoryObject as CursorPagingPlayHistoryObjectSchema
...
from spotify_python_sdk.type.cursor_paging_play_history_object import CursorPagingPlayHistoryObject
...
from spotify_python_sdk.pydantic.cursor_paging_play_history_object import CursorPagingPlayHistoryObject as CursorPagingPlayHistoryObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = CursorPagingPlayHistoryObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CursorPagingPlayHistoryObject
...
class BaseApi(api_client.Api):
    ...
    def _get_recently_played_tracks_mapped_args(
        self,
    ...
    async def _aget_recently_played_tracks_oapg(
        self,
    ...
    def _get_recently_played_tracks_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRecentlyPlayedTracksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recently_played_tracks(
        self,
        limit: typing.Optional[int] = None,
        after: typing.Optional[int] = None,
        before: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_recently_played_tracks_mapped_args(
            limit=limit,
            after=after,
            before=before,
        )
        return await self._aget_recently_played_tracks_oapg(
    ...
    def get_recently_played_tracks(
        ...
        return self._get_recently_played_tracks_oapg(
            query_params=args.query,
        )

class GetRecentlyPlayedTracks(BaseApi):
    ...
    async def aget_recently_played_tracks(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CursorPagingPlayHistoryObjectPydantic:
        raw_response = await self.raw.aget_recently_played_tracks(
            limit=limit,
            after=after,
            before=before,
            **kwargs,
        ...
        if validate:
            return RootModel[CursorPagingPlayHistoryObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(CursorPagingPlayHistoryObjectPydantic, raw_response.body)
    ...
    def get_recently_played_tracks(
        ...
        raw_response = self.raw.get_recently_played_tracks(
            limit=limit,
            after=after,
            before=before,
        )
