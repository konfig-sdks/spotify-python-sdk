...
from spotify_python_sdk.model.users_unfollow_artists_users_request import UsersUnfollowArtistsUsersRequest as UsersUnfollowArtistsUsersRequestSchema
...
from spotify_python_sdk.model.users_unfollow_artists_users_request_ids import UsersUnfollowArtistsUsersRequestIds as UsersUnfollowArtistsUsersRequestIdsSchema
...
from spotify_python_sdk.type.users_unfollow_artists_users_request_ids import UsersUnfollowArtistsUsersRequestIds
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response
from spotify_python_sdk.type.users_unfollow_artists_users_request import UsersUnfollowArtistsUsersRequest
...
from spotify_python_sdk.pydantic.users_unfollow_artists_users_request import UsersUnfollowArtistsUsersRequest as UsersUnfollowArtistsUsersRequestPydantic
...
from spotify_python_sdk.pydantic.users_unfollow_artists_users_request_ids import UsersUnfollowArtistsUsersRequestIds as UsersUnfollowArtistsUsersRequestIdsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UsersUnfollowArtistsUsersRequestSchema


request_body_users_unfollow_artists_users_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _unfollow_artists_users_mapped_args(
        self,
        type: str,
        ids: str,
        ids: typing.Optional[UsersUnfollowArtistsUsersRequestIds] = None,
    ...
    async def _aunfollow_artists_users_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_users_unfollow_artists_users_request.serialize(body, content_type)
    ...
    def _unfollow_artists_users_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UnfollowArtistsUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunfollow_artists_users(
        self,
        type: str,
        ids: str,
        ids: typing.Optional[UsersUnfollowArtistsUsersRequestIds] = None,
        **kwargs,
        ...
        args = self._unfollow_artists_users_mapped_args(
            type=type,
            ids=ids,
            ids=ids,
        )
        return await self._aunfollow_artists_users_oapg(
            body=args.body,
    ...
    def unfollow_artists_users(
        ...
        return self._unfollow_artists_users_oapg(
            body=args.body,
            query_params=args.query,
        )

class UnfollowArtistsUsers(BaseApi):
    ...
    async def aunfollow_artists_users(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunfollow_artists_users(
            type=type,
            ids=ids,
            ids=ids,
            **kwargs,
    ...
    def unfollow_artists_users(
        ...
        raw_response = self.raw.unfollow_artists_users(
            type=type,
            ids=ids,
            ids=ids,
        )
