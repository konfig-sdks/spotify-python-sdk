...
from spotify_python_sdk.model.paging_saved_show_object import PagingSavedShowObject as PagingSavedShowObjectSchema
...
from spotify_python_sdk.type.paging_saved_show_object import PagingSavedShowObject
...
from spotify_python_sdk.pydantic.paging_saved_show_object import PagingSavedShowObject as PagingSavedShowObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSavedShowObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSavedShowObject
...
class BaseApi(api_client.Api):
    ...
    def _get_user_saved_shows_mapped_args(
        self,
    ...
    async def _aget_user_saved_shows_oapg(
        self,
    ...
    def _get_user_saved_shows_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserSavedShowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_saved_shows(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_user_saved_shows_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_user_saved_shows_oapg(
    ...
    def get_user_saved_shows(
        ...
        return self._get_user_saved_shows_oapg(
            query_params=args.query,
        )

class GetUserSavedShows(BaseApi):
    ...
    async def aget_user_saved_shows(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSavedShowObjectPydantic:
        raw_response = await self.raw.aget_user_saved_shows(
            limit=limit,
            offset=offset,
            **kwargs,
        )
        if validate:
            return RootModel[PagingSavedShowObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSavedShowObjectPydantic, raw_response.body)
    ...
    def get_user_saved_shows(
        ...
        raw_response = self.raw.get_user_saved_shows(
            limit=limit,
            offset=offset,
        )
        if validate:
