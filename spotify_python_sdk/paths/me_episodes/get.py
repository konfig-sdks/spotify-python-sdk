...
from spotify_python_sdk.model.paging_saved_episode_object import PagingSavedEpisodeObject as PagingSavedEpisodeObjectSchema
...
from spotify_python_sdk.type.paging_saved_episode_object import PagingSavedEpisodeObject
...
from spotify_python_sdk.pydantic.paging_saved_episode_object import PagingSavedEpisodeObject as PagingSavedEpisodeObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSavedEpisodeObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSavedEpisodeObject
...
class BaseApi(api_client.Api):
    ...
    def _get_user_saved_episodes_mapped_args(
        self,
    ...
    async def _aget_user_saved_episodes_oapg(
        self,
    ...
    def _get_user_saved_episodes_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetUserSavedEpisodesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_saved_episodes(
        self,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_user_saved_episodes_mapped_args(
            market=market,
            limit=limit,
            offset=offset,
        )
        return await self._aget_user_saved_episodes_oapg(
    ...
    def get_user_saved_episodes(
        ...
        return self._get_user_saved_episodes_oapg(
            query_params=args.query,
        )

class GetUserSavedEpisodes(BaseApi):
    ...
    async def aget_user_saved_episodes(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSavedEpisodeObjectPydantic:
        raw_response = await self.raw.aget_user_saved_episodes(
            market=market,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return RootModel[PagingSavedEpisodeObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSavedEpisodeObjectPydantic, raw_response.body)
    ...
    def get_user_saved_episodes(
        ...
        raw_response = self.raw.get_user_saved_episodes(
            market=market,
            limit=limit,
            offset=offset,
        )
