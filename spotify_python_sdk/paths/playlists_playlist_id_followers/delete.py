...
class BaseApi(api_client.Api):
    ...
    def _unfollow_playlist_mapped_args(
        self,
        playlist_id: str,
    ...
    async def _aunfollow_playlist_oapg(
        self,
...
class UnfollowPlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunfollow_playlist(
        self,
        playlist_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unfollow_playlist_mapped_args(
            playlist_id=playlist_id,
        )
        return await self._aunfollow_playlist_oapg(
    ...
    def unfollow_playlist(
        ...
        return self._unfollow_playlist_oapg(
            path_params=args.path,
        )

class UnfollowPlaylist(BaseApi):
    ...
    async def aunfollow_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunfollow_playlist(
            playlist_id=playlist_id,
            **kwargs,
        )
    ...
    def unfollow_playlist(
        ...
        raw_response = self.raw.unfollow_playlist(
            playlist_id=playlist_id,
        )
