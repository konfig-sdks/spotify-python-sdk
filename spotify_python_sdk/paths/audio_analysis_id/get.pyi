...
from spotify_python_sdk.model.audio_analysis_object import AudioAnalysisObject as AudioAnalysisObjectSchema
...
from spotify_python_sdk.type.audio_analysis_object import AudioAnalysisObject
...
from spotify_python_sdk.pydantic.audio_analysis_object import AudioAnalysisObject as AudioAnalysisObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = AudioAnalysisObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AudioAnalysisObject
...
class BaseApi(api_client.Api):
    ...
    def _get_audio_analysis_mapped_args(
        self,
        id: str,
    ...
    async def _aget_audio_analysis_oapg(
        self,
...
class GetAudioAnalysisRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_audio_analysis(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_audio_analysis_mapped_args(
            id=id,
        )
        return await self._aget_audio_analysis_oapg(
    ...
    def get_audio_analysis(
        ...
        return self._get_audio_analysis_oapg(
            path_params=args.path,
        )

class GetAudioAnalysis(BaseApi):
    ...
    async def aget_audio_analysis(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AudioAnalysisObjectPydantic:
        raw_response = await self.raw.aget_audio_analysis(
            id=id,
            **kwargs,
        )
        if validate:
            return AudioAnalysisObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(AudioAnalysisObjectPydantic, raw_response.body)
    ...
    def get_audio_analysis(
        ...
        raw_response = self.raw.get_audio_analysis(
            id=id,
        )
        if validate:
            return AudioAnalysisObjectPydantic(**raw_response.body)
