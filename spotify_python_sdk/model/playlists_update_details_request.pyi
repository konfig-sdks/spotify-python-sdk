...
class PlaylistsUpdateDetailsRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description"], typing_extensions.Literal["name"], typing_extensions.Literal["public"], typing_extensions.Literal["collaborative"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description"], typing_extensions.Literal["name"], typing_extensions.Literal["public"], typing_extensions.Literal["collaborative"], str, ]):
