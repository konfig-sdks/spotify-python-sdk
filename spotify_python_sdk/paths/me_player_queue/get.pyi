...
from spotify_python_sdk.model.queue_object import QueueObject as QueueObjectSchema
...
from spotify_python_sdk.type.queue_object import QueueObject
...
from spotify_python_sdk.pydantic.queue_object import QueueObject as QueueObjectPydantic

SchemaFor200ResponseBodyApplicationJson = QueueObjectSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_user_queue_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_user_queue_oapg(
        self,
...
class GetUserQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_queue(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_user_queue_mapped_args(
        )
        return await self._aget_user_queue_oapg(
            **kwargs,
        )
    ...
    def get_user_queue(
        ...
        return self._get_user_queue_oapg(
        )

class GetUserQueue(BaseApi):
    ...
    async def aget_user_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_user_queue(
            **kwargs,
        )
        if validate:
            return QueueObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(QueueObjectPydantic, raw_response.body)
    ...
    def get_user_queue(
        ...
        raw_response = self.raw.get_user_queue(
        )
        if validate:
            return QueueObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(QueueObjectPydantic, raw_response.body)
