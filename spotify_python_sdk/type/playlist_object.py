...
class RequiredPlaylistObject(TypedDict):
    pass

class OptionalPlaylistObject(TypedDict, total=False):
...
class PlaylistObject(RequiredPlaylistObject, OptionalPlaylistObject):
    pass
