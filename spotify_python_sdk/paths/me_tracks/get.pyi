...
from spotify_python_sdk.model.paging_saved_track_object import PagingSavedTrackObject as PagingSavedTrackObjectSchema
...
from spotify_python_sdk.type.paging_saved_track_object import PagingSavedTrackObject
...
from spotify_python_sdk.pydantic.paging_saved_track_object import PagingSavedTrackObject as PagingSavedTrackObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSavedTrackObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSavedTrackObject
...
class BaseApi(api_client.Api):
    ...
    def _get_user_saved_mapped_args(
        self,
    ...
    async def _aget_user_saved_oapg(
        self,
...
class GetUserSavedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_saved(
        self,
        market: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_user_saved_mapped_args(
            market=market,
            limit=limit,
            offset=offset,
        )
        return await self._aget_user_saved_oapg(
    ...
    def get_user_saved(
        ...
        return self._get_user_saved_oapg(
            query_params=args.query,
        )

class GetUserSaved(BaseApi):
    ...
    async def aget_user_saved(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSavedTrackObjectPydantic:
        raw_response = await self.raw.aget_user_saved(
            market=market,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return RootModel[PagingSavedTrackObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSavedTrackObjectPydantic, raw_response.body)
    ...
    def get_user_saved(
        ...
        raw_response = self.raw.get_user_saved(
            market=market,
            limit=limit,
            offset=offset,
        )
