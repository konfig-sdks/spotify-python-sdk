...
from spotify_python_sdk.model.artists_get_top_tracks_response import ArtistsGetTopTracksResponse as ArtistsGetTopTracksResponseSchema
...
from spotify_python_sdk.type.artists_get_top_tracks_response import ArtistsGetTopTracksResponse
...
from spotify_python_sdk.pydantic.artists_get_top_tracks_response import ArtistsGetTopTracksResponse as ArtistsGetTopTracksResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ArtistsGetTopTracksResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ArtistsGetTopTracksResponse
...
class GetMultipleByIds(BaseApi):
    ...
    async def aget_multiple_by_ids(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ArtistsGetTopTracksResponsePydantic:
        ...
        if validate:
            return ArtistsGetTopTracksResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ArtistsGetTopTracksResponsePydantic, raw_response.body)
