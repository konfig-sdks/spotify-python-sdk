...
from spotify_python_sdk.model.episodes_save_current_user_library_request_ids import EpisodesSaveCurrentUserLibraryRequestIds as EpisodesSaveCurrentUserLibraryRequestIdsSchema
from spotify_python_sdk.model.episodes_save_current_user_library_request import EpisodesSaveCurrentUserLibraryRequest as EpisodesSaveCurrentUserLibraryRequestSchema
...
from spotify_python_sdk.type.episodes_save_current_user_library_request_ids import EpisodesSaveCurrentUserLibraryRequestIds
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response
from spotify_python_sdk.type.episodes_save_current_user_library_request import EpisodesSaveCurrentUserLibraryRequest

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.episodes_save_current_user_library_request import EpisodesSaveCurrentUserLibraryRequest as EpisodesSaveCurrentUserLibraryRequestPydantic
from spotify_python_sdk.pydantic.episodes_save_current_user_library_request_ids import EpisodesSaveCurrentUserLibraryRequestIds as EpisodesSaveCurrentUserLibraryRequestIdsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EpisodesSaveCurrentUserLibraryRequestSchema


request_body_episodes_save_current_user_library_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_current_user_library_1_mapped_args(
        self,
        ids: str,
        ids: typing.Optional[EpisodesSaveCurrentUserLibraryRequestIds] = None,
    ...
    async def _asave_current_user_library_1_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_episodes_save_current_user_library_request.serialize(body, content_type)
    ...
    def _save_current_user_library_1_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SaveCurrentUserLibrary1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asave_current_user_library_1(
        self,
        ids: str,
        ids: typing.Optional[EpisodesSaveCurrentUserLibraryRequestIds] = None,
        **kwargs,
        ...
        args = self._save_current_user_library_1_mapped_args(
            ids=ids,
            ids=ids,
        )
        return await self._asave_current_user_library_1_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def save_current_user_library_1(
        self,
        ids: str,
        ids: typing.Optional[EpisodesSaveCurrentUserLibraryRequestIds] = None,
    ) -> typing.Union[
        ...
        return self._save_current_user_library_1_oapg(
            body=args.body,
            query_params=args.query,
        )

class SaveCurrentUserLibrary1(BaseApi):
    ...
    async def asave_current_user_library_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asave_current_user_library_1(
            ids=ids,
            ids=ids,
            **kwargs,
        )
    ...
    def save_current_user_library_1(
        ...
        raw_response = self.raw.save_current_user_library_1(
            ids=ids,
            ids=ids,
        )
