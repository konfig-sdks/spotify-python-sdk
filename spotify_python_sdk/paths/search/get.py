...
from spotify_python_sdk.model.search_spotify_catalog_info_response import SearchSpotifyCatalogInfoResponse as SearchSpotifyCatalogInfoResponseSchema
...
from spotify_python_sdk.type.search_spotify_catalog_info_response import SearchSpotifyCatalogInfoResponse
...
from spotify_python_sdk.pydantic.search_spotify_catalog_info_response import SearchSpotifyCatalogInfoResponse as SearchSpotifyCatalogInfoResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'include_external': typing.Union[IncludeExternalSchema, str, ],
    },
    total=False
)
...
request_query_include_external = api_client.QueryParameter(
    name="include_external",
    style=api_client.ParameterStyle.FORM,
    schema=IncludeExternalSchema,
    explode=True,
)
_auth = [
    'oauth_2_0',
]
SchemaFor200ResponseBodyApplicationJson = SearchSpotifyCatalogInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SearchSpotifyCatalogInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _spotify_catalog_info_mapped_args(
        self,
        q: str,
        ...
        include_external: typing.Optional[str] = None,
        ...
        if include_external is not None:
            _query_params["include_external"] = include_external
        args.query = _query_params
        return args

    async def _aspotify_catalog_info_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_include_external,
        ):
    ...
    def _spotify_catalog_info_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SpotifyCatalogInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aspotify_catalog_info(
        self,
        q: str,
        type: typing.List[str],
        market: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._spotify_catalog_info_mapped_args(
            q=q,
            type=type,
            market=market,
            limit=limit,
        ...
        return await self._aspotify_catalog_info_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def spotify_catalog_info(
        self,
        q: str,
        type: typing.List[str],
        market: typing.Optional[str] = None,
        ...
        return self._spotify_catalog_info_oapg(
            query_params=args.query,
        )

class SpotifyCatalogInfo(BaseApi):
    ...
    async def aspotify_catalog_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SearchSpotifyCatalogInfoResponsePydantic:
        raw_response = await self.raw.aspotify_catalog_info(
            q=q,
            type=type,
            market=market,
            limit=limit,
        ...
        if validate:
            return SearchSpotifyCatalogInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SearchSpotifyCatalogInfoResponsePydantic, raw_response.body)
    ...
    def spotify_catalog_info(
        ...
        raw_response = self.raw.spotify_catalog_info(
            q=q,
            type=type,
            market=market,
            limit=limit,
