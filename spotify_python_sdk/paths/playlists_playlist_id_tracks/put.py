...
from spotify_python_sdk.model.playlists_update_playlist_items_request_uris import PlaylistsUpdatePlaylistItemsRequestUris as PlaylistsUpdatePlaylistItemsRequestUrisSchema
...
from spotify_python_sdk.model.playlists_update_playlist_items_request import PlaylistsUpdatePlaylistItemsRequest as PlaylistsUpdatePlaylistItemsRequestSchema

from spotify_python_sdk.type.playlists_update_playlist_items_request import PlaylistsUpdatePlaylistItemsRequest
...
from spotify_python_sdk.pydantic.playlists_update_playlist_items_request import PlaylistsUpdatePlaylistItemsRequest as PlaylistsUpdatePlaylistItemsRequestPydantic
...
from spotify_python_sdk.pydantic.playlists_update_playlist_items_request_uris import PlaylistsUpdatePlaylistItemsRequestUris as PlaylistsUpdatePlaylistItemsRequestUrisPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PlaylistsUpdatePlaylistItemsRequestSchema


request_body_playlists_update_playlist_items_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PlaylistsRemoveItemsResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_playlist_items_mapped_args(
        self,
        playlist_id: str,
        uris: typing.Optional[PlaylistsUpdatePlaylistItemsRequestUris] = None,
        range_start: typing.Optional[int] = None,
        insert_before: typing.Optional[int] = None,
        range_length: typing.Optional[int] = None,
        ...
        if range_start is not None:
            _body["range_start"] = range_start
        if insert_before is not None:
            _body["insert_before"] = insert_before
        if range_length is not None:
            _body["range_length"] = range_length
        if snapshot_id is not None:
            _body["snapshot_id"] = snapshot_id
        args.body = _body
        if uris is not None:
    ...
    async def _aupdate_playlist_items_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_playlists_update_playlist_items_request.serialize(body, content_type)
    ...
    def _update_playlist_items_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdatePlaylistItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_playlist_items(
        self,
        playlist_id: str,
        uris: typing.Optional[PlaylistsUpdatePlaylistItemsRequestUris] = None,
        range_start: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._update_playlist_items_mapped_args(
        ...
        return await self._aupdate_playlist_items_oapg(
            body=args.body,
    ...
    def update_playlist_items(
        ...
        return self._update_playlist_items_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdatePlaylistItems(BaseApi):
    ...
    async def aupdate_playlist_items(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_playlist_items(
            playlist_id=playlist_id,
            uris=uris,
            range_start=range_start,
            insert_before=insert_before,
    ...
    def update_playlist_items(
        ...
        raw_response = self.raw.update_playlist_items(
            playlist_id=playlist_id,
            uris=uris,
            range_start=range_start,
            insert_before=insert_before,
