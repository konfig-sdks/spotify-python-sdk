...
from spotify_python_sdk.model.episode_object import EpisodeObject as EpisodeObjectSchema
...
from spotify_python_sdk.pydantic.episode_object import EpisodeObject as EpisodeObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = EpisodeObjectSchema
...
class GetSingleById(BaseApi):
    ...
    async def aget_single_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[EpisodeObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(EpisodeObjectPydantic, raw_response.body)
