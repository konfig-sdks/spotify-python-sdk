...
class PlaylistsRemoveItemsRequestTracksItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["uri", ], str]):
    ...
    ) -> 'PlaylistsRemoveItemsRequestTracksItem':
