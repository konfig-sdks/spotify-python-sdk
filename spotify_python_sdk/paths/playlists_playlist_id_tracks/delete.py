...
from spotify_python_sdk.model.playlists_remove_items_request_tracks import PlaylistsRemoveItemsRequestTracks as PlaylistsRemoveItemsRequestTracksSchema
from spotify_python_sdk.model.playlists_remove_items_request import PlaylistsRemoveItemsRequest as PlaylistsRemoveItemsRequestSchema
...
from spotify_python_sdk.type.playlists_remove_items_request import PlaylistsRemoveItemsRequest
...
from spotify_python_sdk.type.playlists_remove_items_request_tracks import PlaylistsRemoveItemsRequestTracks

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.playlists_remove_items_request import PlaylistsRemoveItemsRequest as PlaylistsRemoveItemsRequestPydantic
...
from spotify_python_sdk.pydantic.playlists_remove_items_request_tracks import PlaylistsRemoveItemsRequestTracks as PlaylistsRemoveItemsRequestTracksPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PlaylistsRemoveItemsRequestSchema


request_body_playlists_remove_items_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _remove_items_mapped_args(
        self,
        tracks: PlaylistsRemoveItemsRequestTracks,
        playlist_id: str,
    ...
    async def _aremove_items_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_playlists_remove_items_request.serialize(body, content_type)
...
class RemoveItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_items(
        self,
        tracks: PlaylistsRemoveItemsRequestTracks,
        playlist_id: str,
        snapshot_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._remove_items_mapped_args(
            tracks=tracks,
            playlist_id=playlist_id,
            snapshot_id=snapshot_id,
        )
        return await self._aremove_items_oapg(
            body=args.body,
    ...
    def remove_items(
        ...
        return self._remove_items_oapg(
            body=args.body,
            path_params=args.path,
        )

class RemoveItems(BaseApi):
    ...
    async def aremove_items(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_items(
            tracks=tracks,
            playlist_id=playlist_id,
            snapshot_id=snapshot_id,
            **kwargs,
    ...
    def remove_items(
        ...
        raw_response = self.raw.remove_items(
            tracks=tracks,
            playlist_id=playlist_id,
            snapshot_id=snapshot_id,
        )
