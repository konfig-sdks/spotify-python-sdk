...
class BaseApi(api_client.Api):
    ...
    def _set_repeat_mode_mapped_args(
        self,
        state: str,
    ...
    async def _aset_repeat_mode_oapg(
        self,
...
class SetRepeatModeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_repeat_mode(
        self,
        state: str,
        device_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._set_repeat_mode_mapped_args(
            state=state,
            device_id=device_id,
        )
        return await self._aset_repeat_mode_oapg(
    ...
    def set_repeat_mode(
        ...
        return self._set_repeat_mode_oapg(
            query_params=args.query,
        )

class SetRepeatMode(BaseApi):
    ...
    async def aset_repeat_mode(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_repeat_mode(
            state=state,
            device_id=device_id,
            **kwargs,
        )
    ...
    def set_repeat_mode(
        ...
        raw_response = self.raw.set_repeat_mode(
            state=state,
            device_id=device_id,
        )
