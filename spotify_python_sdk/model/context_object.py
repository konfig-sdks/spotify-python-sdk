...
class ContextObject(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "href", "external_urls", "uri", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "href", "external_urls", "uri", ], str]):
