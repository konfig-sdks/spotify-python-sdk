...
from spotify_python_sdk.model.albums_save_current_user_library_request_ids import AlbumsSaveCurrentUserLibraryRequestIds as AlbumsSaveCurrentUserLibraryRequestIdsSchema
from spotify_python_sdk.model.albums_save_current_user_library_request import AlbumsSaveCurrentUserLibraryRequest as AlbumsSaveCurrentUserLibraryRequestSchema
...
from spotify_python_sdk.type.albums_save_current_user_library_request_ids import AlbumsSaveCurrentUserLibraryRequestIds
...
from spotify_python_sdk.type.albums_save_current_user_library_request import AlbumsSaveCurrentUserLibraryRequest
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.albums_save_current_user_library_request import AlbumsSaveCurrentUserLibraryRequest as AlbumsSaveCurrentUserLibraryRequestPydantic
...
from spotify_python_sdk.pydantic.albums_save_current_user_library_request_ids import AlbumsSaveCurrentUserLibraryRequestIds as AlbumsSaveCurrentUserLibraryRequestIdsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AlbumsSaveCurrentUserLibraryRequestSchema


request_body_albums_save_current_user_library_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _save_current_user_library_0_mapped_args(
        self,
        ids: str,
        ids: typing.Optional[AlbumsSaveCurrentUserLibraryRequestIds] = None,
    ...
    async def _asave_current_user_library_0_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_albums_save_current_user_library_request.serialize(body, content_type)
    ...
    def _save_current_user_library_0_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class SaveCurrentUserLibrary0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asave_current_user_library_0(
        self,
        ids: str,
        ids: typing.Optional[AlbumsSaveCurrentUserLibraryRequestIds] = None,
        **kwargs,
        ...
        args = self._save_current_user_library_0_mapped_args(
            ids=ids,
            ids=ids,
        )
        return await self._asave_current_user_library_0_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def save_current_user_library_0(
        self,
        ids: str,
        ids: typing.Optional[AlbumsSaveCurrentUserLibraryRequestIds] = None,
    ) -> typing.Union[
        ...
        return self._save_current_user_library_0_oapg(
            body=args.body,
            query_params=args.query,
        )

class SaveCurrentUserLibrary0(BaseApi):
    ...
    async def asave_current_user_library_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asave_current_user_library_0(
            ids=ids,
            ids=ids,
            **kwargs,
        )
    ...
    def save_current_user_library_0(
        ...
        raw_response = self.raw.save_current_user_library_0(
            ids=ids,
            ids=ids,
        )
