...
class BaseApi(api_client.Api):
    ...
    def _check_user_saved_mapped_args(
        self,
        ids: str,
    ...
    async def _acheck_user_saved_oapg(
        self,
...
class CheckUserSavedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_user_saved(
        self,
        ids: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_user_saved_mapped_args(
            ids=ids,
        )
        return await self._acheck_user_saved_oapg(
    ...
    def check_user_saved(
        ...
        return self._check_user_saved_oapg(
            query_params=args.query,
        )

class CheckUserSaved(BaseApi):
    ...
    async def acheck_user_saved(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_user_saved(
            ids=ids,
            **kwargs,
        )
        if validate:
    ...
    def check_user_saved(
        ...
        raw_response = self.raw.check_user_saved(
            ids=ids,
        )
        if validate:
            return RootModel[AudiobooksCheckUserSavedResponsePydantic](raw_response.body).root
