...
from spotify_python_sdk.model.paging_simplified_audiobook_object import PagingSimplifiedAudiobookObject as PagingSimplifiedAudiobookObjectSchema
...
from spotify_python_sdk.type.paging_simplified_audiobook_object import PagingSimplifiedAudiobookObject

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.paging_simplified_audiobook_object import PagingSimplifiedAudiobookObject as PagingSimplifiedAudiobookObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingSimplifiedAudiobookObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingSimplifiedAudiobookObject
...
class ListSavedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_saved(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._list_saved_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._alist_saved_oapg(
    ...
    def list_saved(
        ...
        return self._list_saved_oapg(
            query_params=args.query,
        )

class ListSaved(BaseApi):
    ...
    async def alist_saved(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingSimplifiedAudiobookObjectPydantic:
        raw_response = await self.raw.alist_saved(
            limit=limit,
            offset=offset,
            **kwargs,
        )
        if validate:
            return RootModel[PagingSimplifiedAudiobookObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingSimplifiedAudiobookObjectPydantic, raw_response.body)
    ...
    def list_saved(
        ...
        raw_response = self.raw.list_saved(
            limit=limit,
            offset=offset,
        )
        if validate:
