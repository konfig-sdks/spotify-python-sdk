...
from spotify_python_sdk.model.paging_playlist_track_object import PagingPlaylistTrackObject as PagingPlaylistTrackObjectSchema
...
from spotify_python_sdk.type.paging_playlist_track_object import PagingPlaylistTrackObject
...
from spotify_python_sdk.pydantic.paging_playlist_track_object import PagingPlaylistTrackObject as PagingPlaylistTrackObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PagingPlaylistTrackObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingPlaylistTrackObject
...
class BaseApi(api_client.Api):
    ...
    def _get_playlist_items_mapped_args(
        self,
        playlist_id: str,
    ...
    async def _aget_playlist_items_oapg(
        self,
...
class GetPlaylistItemsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_playlist_items(
        self,
        playlist_id: str,
        market: typing.Optional[str] = None,
        fields: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_playlist_items_mapped_args(
        ...
        return await self._aget_playlist_items_oapg(
    ...
    def get_playlist_items(
        ...
        return self._get_playlist_items_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPlaylistItems(BaseApi):
    ...
    async def aget_playlist_items(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingPlaylistTrackObjectPydantic:
        raw_response = await self.raw.aget_playlist_items(
            playlist_id=playlist_id,
            market=market,
            fields=fields,
            limit=limit,
        ...
        if validate:
            return RootModel[PagingPlaylistTrackObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingPlaylistTrackObjectPydantic, raw_response.body)
    ...
    def get_playlist_items(
        ...
        raw_response = self.raw.get_playlist_items(
            playlist_id=playlist_id,
            market=market,
            fields=fields,
            limit=limit,
