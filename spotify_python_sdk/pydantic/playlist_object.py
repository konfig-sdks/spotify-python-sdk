...
from spotify_python_sdk.pydantic.paging_playlist_track_object import PagingPlaylistTrackObject
...
class PlaylistObject(BaseModel):
    ...
    tracks: typing.Optional[PagingPlaylistTrackObject] = Field(None, alias='tracks')
