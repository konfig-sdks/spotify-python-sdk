...
from spotify_python_sdk.model.shows_get_multiple_shows_info_response import ShowsGetMultipleShowsInfoResponse as ShowsGetMultipleShowsInfoResponseSchema
...
from spotify_python_sdk.type.shows_get_multiple_shows_info_response import ShowsGetMultipleShowsInfoResponse
from spotify_python_sdk.type.albums_get_information403_response import AlbumsGetInformation403Response

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.shows_get_multiple_shows_info_response import ShowsGetMultipleShowsInfoResponse as ShowsGetMultipleShowsInfoResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ShowsGetMultipleShowsInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShowsGetMultipleShowsInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_multiple_shows_info_mapped_args(
        self,
        ids: str,
    ...
    async def _aget_multiple_shows_info_oapg(
        self,
    ...
    def _get_multiple_shows_info_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMultipleShowsInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_multiple_shows_info(
        self,
        ids: str,
        market: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_multiple_shows_info_mapped_args(
            ids=ids,
            market=market,
        )
        return await self._aget_multiple_shows_info_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_multiple_shows_info(
        self,
        ids: str,
        market: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._get_multiple_shows_info_oapg(
            query_params=args.query,
        )

class GetMultipleShowsInfo(BaseApi):
    ...
    async def aget_multiple_shows_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShowsGetMultipleShowsInfoResponsePydantic:
        raw_response = await self.raw.aget_multiple_shows_info(
            ids=ids,
            market=market,
            **kwargs,
        )
        if validate:
            return ShowsGetMultipleShowsInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ShowsGetMultipleShowsInfoResponsePydantic, raw_response.body)
    ...
    def get_multiple_shows_info(
        ...
        raw_response = self.raw.get_multiple_shows_info(
            ids=ids,
            market=market,
        )
        if validate:
