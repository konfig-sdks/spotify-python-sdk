...
class BaseApi(api_client.Api):
    ...
    def _check_if_follows_playlist_mapped_args(
        self,
        playlist_id: str,
        ids: str,
    ...
    async def _acheck_if_follows_playlist_oapg(
        self,
    ...
    def _check_if_follows_playlist_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CheckIfFollowsPlaylistRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_if_follows_playlist(
        self,
        playlist_id: str,
        ids: str,
        **kwargs,
        ...
        args = self._check_if_follows_playlist_mapped_args(
            playlist_id=playlist_id,
            ids=ids,
        )
        return await self._acheck_if_follows_playlist_oapg(
    ...
    def check_if_follows_playlist(
        ...
        return self._check_if_follows_playlist_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class CheckIfFollowsPlaylist(BaseApi):
    ...
    async def acheck_if_follows_playlist(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_if_follows_playlist(
            playlist_id=playlist_id,
            ids=ids,
            **kwargs,
        )
    ...
    def check_if_follows_playlist(
        ...
        raw_response = self.raw.check_if_follows_playlist(
            playlist_id=playlist_id,
            ids=ids,
        )
        if validate:
