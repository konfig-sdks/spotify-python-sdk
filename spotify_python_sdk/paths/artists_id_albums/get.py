...
from spotify_python_sdk.model.paging_artist_discography_album_object import PagingArtistDiscographyAlbumObject as PagingArtistDiscographyAlbumObjectSchema
...
from spotify_python_sdk.type.paging_artist_discography_album_object import PagingArtistDiscographyAlbumObject
...
from spotify_python_sdk.pydantic.paging_artist_discography_album_object import PagingArtistDiscographyAlbumObject as PagingArtistDiscographyAlbumObjectPydantic
...
# Query params
IncludeGroupsSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'include_groups': typing.Union[IncludeGroupsSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = PagingArtistDiscographyAlbumObjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PagingArtistDiscographyAlbumObject
...
class BaseApi(api_client.Api):
    ...
    def _get_albums_by_id_mapped_args(
        self,
        id: str,
        include_groups: typing.Optional[str] = None,
        ...
        if include_groups is not None:
            _query_params["include_groups"] = include_groups
    ...
    async def _aget_albums_by_id_oapg(
        self,
...
class GetAlbumsByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_albums_by_id(
        self,
        id: str,
        include_groups: typing.Optional[str] = None,
        market: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_albums_by_id_mapped_args(
            id=id,
        ...
        return await self._aget_albums_by_id_oapg(
    ...
    def get_albums_by_id(
        ...
        return self._get_albums_by_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAlbumsById(BaseApi):
    ...
    async def aget_albums_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PagingArtistDiscographyAlbumObjectPydantic:
        raw_response = await self.raw.aget_albums_by_id(
            id=id,
            include_groups=include_groups,
            market=market,
            limit=limit,
        ...
        if validate:
            return RootModel[PagingArtistDiscographyAlbumObjectPydantic](raw_response.body).root
        return api_client.construct_model_instance(PagingArtistDiscographyAlbumObjectPydantic, raw_response.body)
    ...
    def get_albums_by_id(
        ...
        raw_response = self.raw.get_albums_by_id(
            id=id,
            include_groups=include_groups,
            market=market,
            limit=limit,
