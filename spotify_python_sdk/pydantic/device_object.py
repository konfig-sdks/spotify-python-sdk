...
class DeviceObject(BaseModel):
    ...
    is_private_session: typing.Optional[bool] = Field(None, alias='is_private_session')
    ...
    volume_percent: typing.Optional[typing.Optional[int]] = Field(None, alias='volume_percent')

    # If this device can be used to set the volume.
    supports_volume: typing.Optional[bool] = Field(None, alias='supports_volume')
    class Config:
