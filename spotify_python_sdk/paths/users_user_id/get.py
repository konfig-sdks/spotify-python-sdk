...
from spotify_python_sdk.model.public_user_object import PublicUserObject as PublicUserObjectSchema
...
from spotify_python_sdk.type.public_user_object import PublicUserObject
...
from spotify_python_sdk.pydantic.public_user_object import PublicUserObject as PublicUserObjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = PublicUserObjectSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_user_profile_mapped_args(
        self,
        user_id: str,
    ...
    async def _aget_user_profile_oapg(
        self,
...
class GetUserProfileRaw(BaseApi):
    ...
    async def aget_user_profile(
        ...
        **kwargs,
        ...
        args = self._get_user_profile_mapped_args(
            user_id=user_id,
        )
        return await self._aget_user_profile_oapg(
    ...
    def get_user_profile(
        ...
        return self._get_user_profile_oapg(
            path_params=args.path,
        )

class GetUserProfile(BaseApi):
    ...
    async def aget_user_profile(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PublicUserObjectPydantic:
        raw_response = await self.raw.aget_user_profile(
            user_id=user_id,
            **kwargs,
        )
        if validate:
            return PublicUserObjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(PublicUserObjectPydantic, raw_response.body)
    ...
    def get_user_profile(
        ...
        raw_response = self.raw.get_user_profile(
            user_id=user_id,
        )
        if validate:
            return PublicUserObjectPydantic(**raw_response.body)
