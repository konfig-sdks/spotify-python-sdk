...
from spotify_python_sdk.model.tracks_get_multiple_audio_features_response import TracksGetMultipleAudioFeaturesResponse as TracksGetMultipleAudioFeaturesResponseSchema
...
from spotify_python_sdk.type.tracks_get_multiple_audio_features_response import TracksGetMultipleAudioFeaturesResponse
...
from spotify_python_sdk.pydantic.tracks_get_multiple_audio_features_response import TracksGetMultipleAudioFeaturesResponse as TracksGetMultipleAudioFeaturesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TracksGetMultipleAudioFeaturesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TracksGetMultipleAudioFeaturesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_multiple_audio_features_mapped_args(
        self,
        ids: str,
    ...
    async def _aget_multiple_audio_features_oapg(
        self,
    ...
    def _get_multiple_audio_features_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetMultipleAudioFeaturesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_multiple_audio_features(
        self,
        ids: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_multiple_audio_features_mapped_args(
            ids=ids,
        )
        return await self._aget_multiple_audio_features_oapg(
    ...
    def get_multiple_audio_features(
        ...
        return self._get_multiple_audio_features_oapg(
            query_params=args.query,
        )

class GetMultipleAudioFeatures(BaseApi):
    ...
    async def aget_multiple_audio_features(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TracksGetMultipleAudioFeaturesResponsePydantic:
        raw_response = await self.raw.aget_multiple_audio_features(
            ids=ids,
            **kwargs,
        )
        if validate:
            return TracksGetMultipleAudioFeaturesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TracksGetMultipleAudioFeaturesResponsePydantic, raw_response.body)
    ...
    def get_multiple_audio_features(
        ...
        raw_response = self.raw.get_multiple_audio_features(
            ids=ids,
        )
        if validate:
            return TracksGetMultipleAudioFeaturesResponsePydantic(**raw_response.body)
