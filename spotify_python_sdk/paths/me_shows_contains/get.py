...
class BaseApi(api_client.Api):
    ...
    def _check_saved_shows_mapped_args(
        self,
        ids: str,
    ...
    async def _acheck_saved_shows_oapg(
        self,
...
class CheckSavedShowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_saved_shows(
        self,
        ids: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._check_saved_shows_mapped_args(
            ids=ids,
        )
        return await self._acheck_saved_shows_oapg(
    ...
    def check_saved_shows(
        ...
        return self._check_saved_shows_oapg(
            query_params=args.query,
        )

class CheckSavedShows(BaseApi):
    ...
    async def acheck_saved_shows(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_saved_shows(
            ids=ids,
            **kwargs,
        )
        if validate:
    ...
    def check_saved_shows(
        ...
        raw_response = self.raw.check_saved_shows(
            ids=ids,
        )
        if validate:
            return RootModel[AudiobooksCheckUserSavedResponsePydantic](raw_response.body).root
