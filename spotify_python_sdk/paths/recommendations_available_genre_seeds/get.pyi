...
from spotify_python_sdk.model.genres_get_available_seeds_response import GenresGetAvailableSeedsResponse as GenresGetAvailableSeedsResponseSchema
...
from spotify_python_sdk.type.genres_get_available_seeds_response import GenresGetAvailableSeedsResponse

from ...api_client import Dictionary
from spotify_python_sdk.pydantic.genres_get_available_seeds_response import GenresGetAvailableSeedsResponse as GenresGetAvailableSeedsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GenresGetAvailableSeedsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GenresGetAvailableSeedsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_available_seeds_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_available_seeds_oapg(
        self,
...
class GetAvailableSeedsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_available_seeds(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_available_seeds_mapped_args(
        )
        return await self._aget_available_seeds_oapg(
            **kwargs,
        )
    ...
    def get_available_seeds(
        ...
        return self._get_available_seeds_oapg(
        )

class GetAvailableSeeds(BaseApi):

    async def aget_available_seeds(
        self,
        validate: bool = False,
        **kwargs,
    ) -> GenresGetAvailableSeedsResponsePydantic:
        raw_response = await self.raw.aget_available_seeds(
            **kwargs,
        )
        if validate:
            return GenresGetAvailableSeedsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GenresGetAvailableSeedsResponsePydantic, raw_response.body)
    ...
    def get_available_seeds(
        ...
        raw_response = self.raw.get_available_seeds(
        )
        if validate:
            return GenresGetAvailableSeedsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GenresGetAvailableSeedsResponsePydantic, raw_response.body)
