...
class RequiredSavedEpisodeObject(TypedDict):
    pass

class OptionalSavedEpisodeObject(TypedDict, total=False):
...
class SavedEpisodeObject(RequiredSavedEpisodeObject, OptionalSavedEpisodeObject):
    pass
